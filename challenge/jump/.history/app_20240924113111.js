...
class PoseDetector {
  constructor() {
    ...
    this.minimumJumpHeight = 0.05; // Adjust this value based on testing
    this.maximumJumpDuration = 2000; // 2 seconds, adjust if needed
  }
  ...
  checkJumpingPose(landmarks) {
    ...
    // Check if the jump has completed or exceeded the maximum duration
    if (
      ...
      // Ensure that a significant jump was detected
      if (
        ...
        // Reset jump detection if the jump wasn't high enough
