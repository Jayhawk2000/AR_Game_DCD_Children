...
function updateStabilityScores(leftWrist, rightWrist, leftShoulder, rightShoulder, leftHip, rightHip) {
  // Arm stability
  if (prevWristPositions.left && prevWristPositions.right) {
    ...
    armStabilityScore = Math.max(0, armStabilityScore - totalMovement * 50);
  }
  ...
  // Gradually recover stability scores
  armStabilityScore = Math.min(10, armStabilityScore + 0.1);
  trunkStabilityScore = Math.min(10, trunkStabilityScore + 0.1);
}
