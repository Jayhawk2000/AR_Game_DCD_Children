...
function checkBalancePose(landmarks) {
  ...
  const armsTPosition =
    leftArmStatus === "excellent" && rightArmStatus === "excellent";
  ...
  if (oneFootRaised && armsTPosition && headForward) {
    ...
    footInfo.textContent = oneFootRaised
      ? "Keep your foot raised."
      : "Raise one foot higher off the ground.";
    armInfo.textContent = armsTPosition
