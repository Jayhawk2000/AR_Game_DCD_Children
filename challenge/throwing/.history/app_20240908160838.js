...
function calculateTrunkStability() {
  console.log("Calculating trunk stability, max displacement:", maxDisplacement);
  if (maxDisplacement < 0.005) return 10;
  if (maxDisplacement < 0.01) return 9;
  if (maxDisplacement < 0.015) return 8;
  if (maxDisplacement < 0.02) return 7;
  if (maxDisplacement < 0.025) return 6;
  if (maxDisplacement < 0.03) return 5;
  if (maxDisplacement < 0.035) return 4;
  if (maxDisplacement < 0.04) return 3;
  if (maxDisplacement < 0.045) return 2;
  if (maxDisplacement < 0.05) return 1;
  return 0;
}
