...
function checkBalancePose(landmarks) {
  ...
  const leftArmStability = checkArmStability(
    leftWrist,
    prevWristPositions.left
  );
  const rightArmStability = checkArmStability(
    rightWrist,
  ...
  if (
    ...
    if (!balancePoseDetected) {
      ...
      return; // Add this line to exit the function after showing results
    } else {
