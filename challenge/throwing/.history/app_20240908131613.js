...
function showResultPage(resultData) {
  ...
  const result = {
    armScore: resultData.armScore,
    trunkScore: resultData.trunkScore,
    totalScore: resultData.totalScore,
    armFeedback: resultData.armFeedback,
    trunkFeedback: resultData.trunkFeedback,
  };

  // Store the result in localStorage
  localStorage.setItem("poseResult", JSON.stringify(result));
