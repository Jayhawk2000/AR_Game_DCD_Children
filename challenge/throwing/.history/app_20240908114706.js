...
function checkBalancePose(landmarks) {
  ...
  const armsRaised = checkArmsRaised(leftShoulder, leftElbow, leftWrist, rightShoulder, rightElbow, rightWrist);
  const headForward = checkHeadForward(nose, leftShoulder, rightShoulder);

  updateStabilityScores(leftWrist, rightWrist, leftShoulder, rightShoulder, leftHip, rightHip);
...
function checkArmsRaised(leftShoulder, leftElbow, leftWrist, rightShoulder, rightElbow, rightWrist) {
