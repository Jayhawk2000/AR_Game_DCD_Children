...
// Flag to track if initial audio has been played
...
class PoseDetector {
  constructor() {
    ...
    this.STARTING_POSITION_HOLD_DURATION = 3000; // 3 seconds hold time
...
function onResults(results) {
  ...
  if (results.poseLandmarks && isDetectionStarted) {
    // Draw pose landmarks with transparent lines
