...
function startProcess() {
  ...
  playAudio("Please stand in a position where your full body is visible");
...
function startCountdown() {
  ...
  if (countdownTimer > 0) {
    ...
    playAudio("Please follow the on-screen text instructions to complete the action");
  }
}
...
function showResultPage(totalScore, armScore, trunkScore) {
  ...
  document.getElementById("armScore").textContent = armScore.toFixed(1);
  document.getElementById("trunkScore").textContent = trunkScore.toFixed(1);
  document.getElementById("armFeedback").textContent = getArmFeedback(armScore);
  document.getElementById("trunkFeedback").textContent = getTrunkFeedback(trunkScore);
