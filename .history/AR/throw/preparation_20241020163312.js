...
function checkSideOnStance(landmarks) {
  ...
  console.log('Instruction element:', instructionText);

  if (instructionText) {
    if (shoulderDiff > 0.1 && hipDiff > 0.1) {
      instructionText.textContent = "Great! You are in the correct side-on stance.";
    } else {
      instructionText.textContent = "Please turn sideways to the camera.";
    }
    console.log('Updated instruction text:', instructionText.textContent);
  } else {
